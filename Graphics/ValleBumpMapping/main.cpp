...
static uint isBumpMapped = 1; // Is bump mapping on?  //ky: removing on/off option. just turn on
...
int main(int argc, char **argv)
{
   ...
   glutCreateWindow("A plane that has been bump mapped");
